...
3. Crie uma branch a partir da branch `master`
  ...
  * Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    * Exemplo: `git checkout -b joaozinho-sd-015-b-trybe-futebol-clube`
...
5. Adicione a sua branch com o novo `commit` ao repositório remoto
  * Usando o exemplo anterior: `git push -u origin joaozinho-sd-015-b-trybe-futebol-clube`
...
- `sd-015-b-trybe-futebol-clube/app/backend/package.json`
...
`sd-015-b-trybe-futebol-clube/app/backend/src/database/config/database.ts`
